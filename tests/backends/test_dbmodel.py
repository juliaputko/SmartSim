...
# def test_inconsistent_parameters(fileutils, wlmutils, mlutils): #jp
#     """Test error when devices_per_node parameter>1 when devices is set to CPU"""

#     # Set experiment name
#     exp_name = "test_add_model_inconsistent_parameters"
